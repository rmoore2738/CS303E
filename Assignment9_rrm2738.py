...
# This function creates the H tree by calling draw_tree
def h_tree(order, center, size):
    draw_tree(center, size)
...
# This function rotates the star drawn by draw_star
...
# This calls the rotator and passes the parameters of it
def animate(x, y):
